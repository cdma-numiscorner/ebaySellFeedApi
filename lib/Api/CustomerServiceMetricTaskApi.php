...
class CustomerServiceMetricTaskApi
{
     ...
     * @param  \OpenAPI\EbaySellFeedApi\Model\CreateServiceMetricsTaskRequest $create_service_metrics_task_request Request payload containing version, feedType, and optional filterCriteria. (required)
     *
     ...
     * @throws \OpenAPI\EbaySellFeedApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\EbaySellFeedApi\Model\ServiceMetricsTask
     */
     ...
     * @throws \OpenAPI\EbaySellFeedApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\EbaySellFeedApi\Model\ServiceMetricsTask, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCustomerServiceMetricTaskWithHttpInfo($task_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\EbaySellFeedApi\Model\ServiceMetricsTask' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\EbaySellFeedApi\Model\ServiceMetricsTask' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\EbaySellFeedApi\Model\ServiceMetricsTask', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\EbaySellFeedApi\Model\ServiceMetricsTask';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\EbaySellFeedApi\Model\ServiceMetricsTask',
     ...
     * @throws \OpenAPI\EbaySellFeedApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\EbaySellFeedApi\Model\CustomerServiceMetricTaskCollection
     */
     ...
     * @throws \OpenAPI\EbaySellFeedApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\EbaySellFeedApi\Model\CustomerServiceMetricTaskCollection, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCustomerServiceMetricTasksWithHttpInfo($date_range = null, $feed_type = null, $limit = null, $look_back_days = null, $offset = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\EbaySellFeedApi\Model\CustomerServiceMetricTaskCollection' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\EbaySellFeedApi\Model\CustomerServiceMetricTaskCollection' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\EbaySellFeedApi\Model\CustomerServiceMetricTaskCollection', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\EbaySellFeedApi\Model\CustomerServiceMetricTaskCollection';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\EbaySellFeedApi\Model\CustomerServiceMetricTaskCollection',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
