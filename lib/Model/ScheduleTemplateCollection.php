...
class ScheduleTemplateCollection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'offset' => 'int',
        'prev' => 'string',
        'schedule_templates' => '\OpenAPI\EbaySellFeedApi\Model\ScheduleTemplateResponse[]',
        'total' => 'int'
    ];
     ...
     *
     * @return \OpenAPI\EbaySellFeedApi\Model\ScheduleTemplateResponse[]|null
     */
     ...
     *
     * @param \OpenAPI\EbaySellFeedApi\Model\ScheduleTemplateResponse[]|null $schedule_templates An array of the schedule templates on this page. An empty array is returned if the filter criteria excludes all tasks.
     *
     * @return self
     */
