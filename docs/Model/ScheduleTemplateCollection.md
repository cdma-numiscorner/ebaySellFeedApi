...
**schedule_templates** | [**\OpenAPI\EbaySellFeedApi\Model\ScheduleTemplateResponse[]**](ScheduleTemplateResponse.md) | An array of the schedule templates on this page. An empty array is returned if the filter criteria excludes all tasks. | [optional]
