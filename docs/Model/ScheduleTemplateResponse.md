...
**supported_configurations** | [**\OpenAPI\EbaySellFeedApi\Model\SupportedConfiguration[]**](SupportedConfiguration.md) | An array of the configuration supported by this template. | [optional]
