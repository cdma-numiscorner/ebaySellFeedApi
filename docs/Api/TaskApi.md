# OpenAPI\EbaySellFeedApi\TaskApi
...
$apiInstance = new OpenAPI\EbaySellFeedApi\Api\TaskApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$create_task_request = new \OpenAPI\EbaySellFeedApi\Model\CreateTaskRequest(); // \OpenAPI\EbaySellFeedApi\Model\CreateTaskRequest | description not needed
...
------------- | ------------- | ------------- | -------------
 **create_task_request** | [**\OpenAPI\EbaySellFeedApi\Model\CreateTaskRequest**](../Model/CreateTaskRequest.md)| description not needed |
...
```php
getTask($task_id): \OpenAPI\EbaySellFeedApi\Model\Task
```
...
[**\OpenAPI\EbaySellFeedApi\Model\Task**](../Model/Task.md)
...
```php
getTasks($date_range, $feed_type, $limit, $look_back_days, $offset, $schedule_id): \OpenAPI\EbaySellFeedApi\Model\TaskCollection
```
...
[**\OpenAPI\EbaySellFeedApi\Model\TaskCollection**](../Model/TaskCollection.md)
