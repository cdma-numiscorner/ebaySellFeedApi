# OpenAPI\EbaySellFeedApi\CustomerServiceMetricTaskApi
 ...
 **create_service_metrics_task_request** | [**\OpenAPI\EbaySellFeedApi\Model\CreateServiceMetricsTaskRequest**](../Model/CreateServiceMetricsTaskRequest.md)| Request payload containing version, feedType, and optional filterCriteria. |
...
```php
getCustomerServiceMetricTask($task_id): \OpenAPI\EbaySellFeedApi\Model\ServiceMetricsTask
```
...
[**\OpenAPI\EbaySellFeedApi\Model\ServiceMetricsTask**](../Model/ServiceMetricsTask.md)
...
```php
getCustomerServiceMetricTasks($date_range, $feed_type, $limit, $look_back_days, $offset): \OpenAPI\EbaySellFeedApi\Model\CustomerServiceMetricTaskCollection
```
...
[**\OpenAPI\EbaySellFeedApi\Model\CustomerServiceMetricTaskCollection**](../Model/CustomerServiceMetricTaskCollection.md)
